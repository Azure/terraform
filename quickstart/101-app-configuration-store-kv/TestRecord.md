...
Error:
	...
	Error:      	Received unexpected error:
	            	...
	            	[31m│[0m [0m[1m[31mError: [0m[0m[1mauthorization.RoleAssignmentsClient#Create: Failure responding to request: StatusCode=403 -- Original Error: autorest/azure: Service returned an error. Status=403 Code="AuthorizationFailed" Message="The client '4035266d-b34b-4c95-b127-865ea8e89865' with object id '0d6e331f-af2e-4b30-b458-ee1cf5cbcd5e' does not have authorization to perform action 'Microsoft.Authorization/roleAssignments/write' over scope '/subscriptions/18ca8bf0-e7e9-4450-83da-2124ec1ce0cb/resourceGroups/rg-vast-magpie/providers/Microsoft.AppConfiguration/configurationStores/appconf-yhqahedmazmxw/providers/Microsoft.Authorization/roleAssignments/225d4e9d-4cf4-0080-f505-9441e87d0779' or the scope is invalid. If access was recently granted, please refresh your credentials."[0m
	            	[31m│[0m [0m
	            	[31m│[0m [0m[0m  with azurerm_role_assignment.appconf_dataowner,
	            	[31m│[0m [0m  on main.tf line 26, in resource "azurerm_role_assignment" "appconf_dataowner":
	            	[31m│[0m [0m  26: resource "azurerm_role_assignment" "appconf_dataowner" [4m{[0m[0m
	            	[31m│[0m [0m
	            	[31m╵[0m[0m}
...
Error:
	...
	Error:      	Received unexpected error:
	            	FatalError{Underlying: error while running command: exit status 1; [31m╷[0m[0m
	            	[31m│[0m [0m[1m[31mError: [0m[0m[1mauthorization.RoleAssignmentsClient#Create: Failure responding to request: StatusCode=403 -- Original Error: autorest/azure: Service returned an error. Status=403 Code="AuthorizationFailed" Message="The client '4035266d-b34b-4c95-b127-865ea8e89865' with object id '0d6e331f-af2e-4b30-b458-ee1cf5cbcd5e' does not have authorization to perform action 'Microsoft.Authorization/roleAssignments/write' over scope '/subscriptions/18ca8bf0-e7e9-4450-83da-2124ec1ce0cb/resourceGroups/rg-trusted-aphid/providers/Microsoft.AppConfiguration/configurationStores/appconf-ioscyhvqohtdd/providers/Microsoft.Authorization/roleAssignments/116a86a6-aafd-8e0e-c433-e5f780204035' or the scope is invalid. If access was recently granted, please refresh your credentials."[0m
	            	[31m│[0m [0m
	            	[31m│[0m [0m[0m  with azurerm_role_assignment.appconf_dataowner,
	            	[31m│[0m [0m  on main.tf line 26, in resource "azurerm_role_assignment" "appconf_dataowner":
	            	[31m│[0m [0m  26: resource "azurerm_role_assignment" "appconf_dataowner" [4m{[0m[0m
...
Error:
	...
	Error:      	Received unexpected error:
	            	FatalError{Underlying: error while running command: exit status 1; [31m╷[0m[0m
	            	[31m│[0m [0m[1m[31mError: [0m[0m[1mbuilding account: could not acquire access token to parse claims: clientCredentialsToken: received HTTP status 401 with response: {"error":"invalid_client","error_description":"AADSTS700213: No matching federated identity record found for presented assertion subject 'repository_owner_id:6844498:repository_id:117169328:environment:crontests'. Check your federated identity credential Subject, Audience and Issuer against the presented assertion. https://learn.microsoft.com/entra/workload-id/workload-identity-federation Trace ID: 3643cc3d-da07-48d0-9784-1d5ccf7e1f00 Correlation ID: 5192718f-4703-456f-8ee3-671e1968884d Timestamp: 2026-02-01 00:23:34Z","error_codes":[700213],"timestamp":"2026-02-01 00:23:34Z","trace_id":"3643cc3d-da07-48d0-9784-1d5ccf7e1f00","correlation_id":"5192718f-4703-456f-8ee3-671e1968884d","error_uri":"https://login.microsoftonline.com/error?code=700213"}[0m
	            	[31m│[0m [0m
	            	[31m│[0m [0m[0m  with provider["registry.terraform.io/hashicorp/azurerm"],
	            	[31m│[0m [0m  on providers.tf line 16, in provider "azurerm":
	            	[31m│[0m [0m  16: provider "azurerm" [4m{[0m[0m
...
Error:
	...
	Error:      	Received unexpected error:
	            	FatalError{Underlying: error while running command: exit status 1; [31m╷[0m[0m
	            	[31m│[0m [0m[1m[31mError: [0m[0m[1mbuilding account: could not acquire access token to parse claims: clientCredentialsToken: received HTTP status 401 with response: {"error":"invalid_client","error_description":"AADSTS700213: No matching federated identity record found for presented assertion subject 'repository_owner_id:6844498:repository_id:117169328:environment:crontests'. Check your federated identity credential Subject, Audience and Issuer against the presented assertion. https://learn.microsoft.com/entra/workload-id/workload-identity-federation Trace ID: 3cd114f9-f362-45f8-a9b0-0a2b6d171100 Correlation ID: 4c9134c8-dddd-4c82-a7c6-e61f741e4dd2 Timestamp: 2026-01-25 00:21:52Z","error_codes":[700213],"timestamp":"2026-01-25 00:21:52Z","trace_id":"3cd114f9-f362-45f8-a9b0-0a2b6d171100","correlation_id":"4c9134c8-dddd-4c82-a7c6-e61f741e4dd2","error_uri":"https://login.microsoftonline.com/error?code=700213"}[0m
	            	[31m│[0m [0m
	            	[31m│[0m [0m[0m  with provider["registry.terraform.io/hashicorp/azurerm"],
	            	[31m│[0m [0m  on providers.tf line 16, in provider "azurerm":
	            	[31m│[0m [0m  16: provider "azurerm" [4m{[0m[0m
...
Error:
	...
	Error:      	Received unexpected error:
	            	FatalError{Underlying: error while running command: exit status 1; [31m╷[0m[0m
	            	[31m│[0m [0m[1m[31mError: [0m[0m[1mbuilding account: could not acquire access token to parse claims: clientCredentialsToken: received HTTP status 401 with response: {"error":"invalid_client","error_description":"AADSTS700213: No matching federated identity record found for presented assertion subject 'repository_owner_id:6844498:repository_id:117169328:environment:crontests'. Check your federated identity credential Subject, Audience and Issuer against the presented assertion. https://learn.microsoft.com/entra/workload-id/workload-identity-federation Trace ID: 4e753b6c-9669-4e6d-a36b-dd1fbe441b00 Correlation ID: 955c3b5c-c909-4a4a-8f56-c5a19ee3bb17 Timestamp: 2026-01-18 00:15:49Z","error_codes":[700213],"timestamp":"2026-01-18 00:15:49Z","trace_id":"4e753b6c-9669-4e6d-a36b-dd1fbe441b00","correlation_id":"955c3b5c-c909-4a4a-8f56-c5a19ee3bb17","error_uri":"https://login.microsoftonline.com/error?code=700213"}[0m
	            	[31m│[0m [0m
	            	[31m│[0m [0m[0m  with provider["registry.terraform.io/hashicorp/azurerm"],
	            	[31m│[0m [0m  on providers.tf line 16, in provider "azurerm":
	            	[31m│[0m [0m  16: provider "azurerm" [4m{[0m[0m
