...
Error:
	...
	Error:      	Received unexpected error:
	            	FatalError{Underlying: error while running command: exit status 1; [31m╷[0m[0m
	            	[31m│[0m [0m[1m[31mError: [0m[0m[1mbuilding account: could not acquire access token to parse claims: clientCredentialsToken: received HTTP status 401 with response: {"error":"invalid_client","error_description":"AADSTS700213: No matching federated identity record found for presented assertion subject 'repository_owner_id:6844498:repository_id:117169328:environment:crontests'. Check your federated identity credential Subject, Audience and Issuer against the presented assertion. https://learn.microsoft.com/entra/workload-id/workload-identity-federation Trace ID: 488d4ea0-5682-432f-a4d0-6d8a74351b00 Correlation ID: 4ef2aa12-6365-42e3-9155-47733e7e75f1 Timestamp: 2026-02-01 00:22:47Z","error_codes":[700213],"timestamp":"2026-02-01 00:22:47Z","trace_id":"488d4ea0-5682-432f-a4d0-6d8a74351b00","correlation_id":"4ef2aa12-6365-42e3-9155-47733e7e75f1","error_uri":"https://login.microsoftonline.com/error?code=700213"}[0m
	            	[31m│[0m [0m
	            	[31m│[0m [0m[0m  with provider["registry.terraform.io/hashicorp/azurerm"],
	            	[31m│[0m [0m  on provider.tf line 14, in provider "azurerm":
	            	[31m│[0m [0m  14: provider "azurerm" [4m{[0m[0m
...
Error:
	...
	Error:      	Received unexpected error:
	            	...
	            	[31m│[0m [0mResource Group Name: "rg-pure-tahr"
	            	[31m│[0m [0mFirewall Policy Name: "azfw-policy"
	            	[31m│[0m [0mRule Collection Group Name: "DefaultNetworkRuleCollectionGroup"): polling after CreateOrUpdate: polling failed: the Azure API returned the following error:
	            	[31m│[0m [0m
	            	...
	            	[31m│[0m [0m[0m
	            	[31m│[0m [0m
	            	[31m│[0m [0m[0m  with azurerm_firewall_policy_rule_collection_group.net_policy_rule_collection_group,
	            	[31m│[0m [0m  on main.tf line 53, in resource "azurerm_firewall_policy_rule_collection_group" "net_policy_rule_collection_group":
	            	[31m│[0m [0m  53: resource "azurerm_firewall_policy_rule_collection_group" "net_policy_rule_collection_group" [4m{[0m[0m
	            	[31m│[0m [0m
	            	[31m╵[0m[0m
	            	[31m╷[0m[0m
	            	[31m│[0m [0m[1m[31mError: [0m[0m[1mcreating Rule Collection Group (Subscription: "9209a73b-48eb-46da-bec6-0858b9eaaa35"
	            	[31m│[0m [0mResource Group Name: "rg-pure-tahr"
	            	[31m│[0m [0mFirewall Policy Name: "azfw-policy"
	            	[31m│[0m [0mRule Collection Group Name: "DefaulApplicationtRuleCollectionGroup"): polling after CreateOrUpdate: polling failed: the Azure API returned the following error:
	            	[31m│[0m [0m
	            	[31m│[0m [0mStatus: "FirewallPolicyUpdateFailed"
	            	[31m│[0m [0mCode: ""
	            	[31m│[0m [0mMessage: "Put on Firewall Policy azfw-policy Failed with 1 faulted referenced firewalls"
	            	...
	            	[31m│[0m [0m[0m
	            	[31m│[0m [0m
	            	[31m│[0m [0m[0m  with azurerm_firewall_policy_rule_collection_group.app_policy_rule_collection_group,
	            	[31m│[0m [0m  on main.tf line 71, in resource "azurerm_firewall_policy_rule_collection_group" "app_policy_rule_collection_group":
	            	[31m│[0m [0m  71: resource "azurerm_firewall_policy_rule_collection_group" "app_policy_rule_collection_group" [4m{[0m[0m
	            	[31m│[0m [0m
	            	[31m╵[0m[0m
	            	[31m╷[0m[0m
	            	...
	            	[31m│[0m [0m  on main.tf line 108, in resource "azurerm_firewall" "fw":
	            	[31m│[0m [0m 108: resource "azurerm_firewall" "fw" [4m{[0m[0m
	            	[31m│[0m [0m
	            	[31m╵[0m[0m}
	Test:       	Test_Quickstarts/quickstart/101-azfw-with-fwpolicy
