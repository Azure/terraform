...
Error:
	...
	Error:      	Received unexpected error:
	            	...
	            	[31m│[0m [0m
	            	[31m╵[0m[0m}
	Test:       	Test_Quickstarts/quickstart/101-azure-storage-account
...
Error:
	...
	Error:      	Received unexpected error:
	            	FatalError{Underlying: error while running command: exit status 1; [31m╷[0m[0m
	            	[31m│[0m [0m[1m[31mError: [0m[0m[1mbuilding account: could not acquire access token to parse claims: clientCredentialsToken: received HTTP status 401 with response: {"error":"invalid_client","error_description":"AADSTS700213: No matching federated identity record found for presented assertion subject 'repository_owner_id:6844498:repository_id:117169328:environment:crontests'. Check your federated identity credential Subject, Audience and Issuer against the presented assertion. https://learn.microsoft.com/entra/workload-id/workload-identity-federation Trace ID: 461d0b1c-f13e-440e-bf1b-ce9d9c242c00 Correlation ID: a8b01099-a118-44f6-b752-a353ad03848d Timestamp: 2026-02-01 00:21:21Z","error_codes":[700213],"timestamp":"2026-02-01 00:21:21Z","trace_id":"461d0b1c-f13e-440e-bf1b-ce9d9c242c00","correlation_id":"a8b01099-a118-44f6-b752-a353ad03848d","error_uri":"https://login.microsoftonline.com/error?code=700213"}[0m
	            	[31m│[0m [0m
	            	[31m│[0m [0m[0m  with provider["registry.terraform.io/hashicorp/azurerm"],
	            	[31m│[0m [0m  on providers.tf line 14, in provider "azurerm":
	            	[31m│[0m [0m  14: provider "azurerm" [4m{[0m[0m
...
Error:
	...
	Error:      	Received unexpected error:
	            	FatalError{Underlying: error while running command: exit status 1; [31m╷[0m[0m
	            	[31m│[0m [0m[1m[31mError: [0m[0m[1mbuilding account: could not acquire access token to parse claims: clientCredentialsToken: received HTTP status 401 with response: {"error":"invalid_client","error_description":"AADSTS700213: No matching federated identity record found for presented assertion subject 'repository_owner_id:6844498:repository_id:117169328:environment:crontests'. Check your federated identity credential Subject, Audience and Issuer against the presented assertion. https://learn.microsoft.com/entra/workload-id/workload-identity-federation Trace ID: 6b6d5c39-c43e-4ffb-b3cf-f80e122f1000 Correlation ID: d9a2da0b-f363-4711-9230-fdc357c9c293 Timestamp: 2026-01-25 00:17:14Z","error_codes":[700213],"timestamp":"2026-01-25 00:17:14Z","trace_id":"6b6d5c39-c43e-4ffb-b3cf-f80e122f1000","correlation_id":"d9a2da0b-f363-4711-9230-fdc357c9c293","error_uri":"https://login.microsoftonline.com/error?code=700213"}[0m
	            	[31m│[0m [0m
	            	[31m│[0m [0m[0m  with provider["registry.terraform.io/hashicorp/azurerm"],
	            	[31m│[0m [0m  on providers.tf line 14, in provider "azurerm":
	            	[31m│[0m [0m  14: provider "azurerm" [4m{[0m[0m
...
Error:
	...
	Error:      	Received unexpected error:
	            	FatalError{Underlying: error while running command: exit status 1; [31m╷[0m[0m
	            	[31m│[0m [0m[1m[31mError: [0m[0m[1mbuilding account: could not acquire access token to parse claims: clientCredentialsToken: received HTTP status 401 with response: {"error":"invalid_client","error_description":"AADSTS700213: No matching federated identity record found for presented assertion subject 'repository_owner_id:6844498:repository_id:117169328:environment:crontests'. Check your federated identity credential Subject, Audience and Issuer against the presented assertion. https://learn.microsoft.com/entra/workload-id/workload-identity-federation Trace ID: 2b92c959-4ee1-458f-87dd-a527c6800600 Correlation ID: fd96b711-979a-4d0f-9b96-8d17aaf58fc0 Timestamp: 2026-01-18 00:14:08Z","error_codes":[700213],"timestamp":"2026-01-18 00:14:08Z","trace_id":"2b92c959-4ee1-458f-87dd-a527c6800600","correlation_id":"fd96b711-979a-4d0f-9b96-8d17aaf58fc0","error_uri":"https://login.microsoftonline.com/error?code=700213"}[0m
	            	[31m│[0m [0m
	            	[31m│[0m [0m[0m  with provider["registry.terraform.io/hashicorp/azurerm"],
	            	[31m│[0m [0m  on providers.tf line 14, in provider "azurerm":
	            	[31m│[0m [0m  14: provider "azurerm" [4m{[0m[0m
...
Error:
	...
	Error:      	Received unexpected error:
	            	terraform configuration not idempotent:[0m[1mrandom_pet.rg_name: Refreshing state... [id=rg-helped-blowfish][0m
	            	[0m[1mrandom_string.name: Refreshing state... [id=kddgqgbu][0m
	            	[0m[1mazurerm_resource_group.rg: Refreshing state... [id=/subscriptions/f7a632a5-49db-4c5e-9828-cd62cb753971/resourceGroups/rg-helped-blowfish][0m
	            	[0m[1mazurerm_storage_account.sa: Refreshing state... [id=/subscriptions/f7a632a5-49db-4c5e-9828-cd62cb753971/resourceGroups/rg-helped-blowfish/providers/Microsoft.Storage/storageAccounts/sakddgqgbu][0m
	            	...
	            	[0m  [33m~[0m[0m resource "azurerm_resource_group" "rg" {
	            	        id         = "/subscriptions/f7a632a5-49db-4c5e-9828-cd62cb753971/resourceGroups/rg-helped-blowfish"
	            	        name       = "rg-helped-blowfish"
	            	      [33m~[0m[0m tags       = {
	            	...
	            	Saved the plan to:
	            	/tmp/101-azure-storage-account832325752/src/quickstart/101-azure-storage-account/tf.plan
	            	
	            	To perform exactly these actions, run the following command to apply:
	            	    terraform apply "/tmp/101-azure-storage-account832325752/src/quickstart/101-azure-storage-account/tf.plan"
	Test:       	Test_Quickstarts/quickstart/101-azure-storage-account
