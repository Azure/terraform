...
| `sku` | Pricing tier of this API Management service. Must be one of the following values: Consumption, Developer, Basic, BasicV2, Standard, StandardV2, Premium, PremiumV2. | BasicV2 |
