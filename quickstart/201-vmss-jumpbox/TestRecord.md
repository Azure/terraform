...
Error:
	...
	Error:      	Received unexpected error:
	            	FatalError{Underlying: error while running command: exit status 1; [31m╷[0m[0m
	            	[31m│[0m [0m[1m[31mError: [0m[0m[1mA resource with the ID "/subscriptions/18ca8bf0-e7e9-4450-83da-2124ec1ce0cb/resourceGroups/myResourceGroup" already exists - to be managed via Terraform this resource needs to be imported into the State. Please see the resource documentation for "azurerm_resource_group" for more information.[0m
	            	[31m│[0m [0m
	            	[31m│[0m [0m[0m  with azurerm_resource_group.vmss,
	            	[31m│[0m [0m  on main.tf line 29, in resource "azurerm_resource_group" "vmss":
	            	[31m│[0m [0m  29: resource "azurerm_resource_group" "vmss" [4m{[0m[0m
	            	[31m│[0m [0m
	            	[31m╵[0m[0m}
	Test:       	Test_Quickstarts/quickstart/201-vmss-jumpbox
...
Error:
	...
	Error:      	Received unexpected error:
	            	FatalError{Underlying: error while running command: exit status 1; [31m╷[0m[0m
	            	[31m│[0m [0m[1m[31mError: [0m[0m[1mbuilding account: could not acquire access token to parse claims: clientCredentialsToken: received HTTP status 401 with response: {"error":"invalid_client","error_description":"AADSTS700213: No matching federated identity record found for presented assertion subject 'repository_owner_id:6844498:repository_id:117169328:environment:crontests'. Check your federated identity credential Subject, Audience and Issuer against the presented assertion. https://learn.microsoft.com/entra/workload-id/workload-identity-federation Trace ID: 8bf8b528-3132-46d5-a2db-d32f95842f00 Correlation ID: 545085b9-8440-4e87-bf4d-79b9b060f780 Timestamp: 2026-02-01 00:14:35Z","error_codes":[700213],"timestamp":"2026-02-01 00:14:35Z","trace_id":"8bf8b528-3132-46d5-a2db-d32f95842f00","correlation_id":"545085b9-8440-4e87-bf4d-79b9b060f780","error_uri":"https://login.microsoftonline.com/error?code=700213"}[0m
	            	[31m│[0m [0m
	            	[31m│[0m [0m[0m  with provider["registry.terraform.io/hashicorp/azurerm"],
	            	[31m│[0m [0m  on main.tf line 12, in provider "azurerm":
	            	[31m│[0m [0m  12: provider "azurerm" [4m{[0m[0m
...
Error:
	...
	Error:      	Received unexpected error:
	            	FatalError{Underlying: error while running command: exit status 1; [31m╷[0m[0m
	            	[31m│[0m [0m[1m[31mError: [0m[0m[1mbuilding account: could not acquire access token to parse claims: clientCredentialsToken: received HTTP status 401 with response: {"error":"invalid_client","error_description":"AADSTS700213: No matching federated identity record found for presented assertion subject 'repository_owner_id:6844498:repository_id:117169328:environment:crontests'. Check your federated identity credential Subject, Audience and Issuer against the presented assertion. https://learn.microsoft.com/entra/workload-id/workload-identity-federation Trace ID: 488d01e2-0089-4f91-8999-6ceb27cf0b00 Correlation ID: 7673e842-3ab4-4c75-a155-e35f4bada2c9 Timestamp: 2026-01-25 00:13:38Z","error_codes":[700213],"timestamp":"2026-01-25 00:13:38Z","trace_id":"488d01e2-0089-4f91-8999-6ceb27cf0b00","correlation_id":"7673e842-3ab4-4c75-a155-e35f4bada2c9","error_uri":"https://login.microsoftonline.com/error?code=700213"}[0m
	            	[31m│[0m [0m
	            	[31m│[0m [0m[0m  with provider["registry.terraform.io/hashicorp/azurerm"],
	            	[31m│[0m [0m  on main.tf line 12, in provider "azurerm":
	            	[31m│[0m [0m  12: provider "azurerm" [4m{[0m[0m
...
Error:
	...
	Error:      	Received unexpected error:
	            	FatalError{Underlying: error while running command: exit status 1; [31m╷[0m[0m
	            	[31m│[0m [0m[1m[31mError: [0m[0m[1mbuilding account: could not acquire access token to parse claims: clientCredentialsToken: received HTTP status 401 with response: {"error":"invalid_client","error_description":"AADSTS700213: No matching federated identity record found for presented assertion subject 'repository_owner_id:6844498:repository_id:117169328:environment:crontests'. Check your federated identity credential Subject, Audience and Issuer against the presented assertion. https://learn.microsoft.com/entra/workload-id/workload-identity-federation Trace ID: 41f1be3d-c2c1-485d-ae44-90570aaf0200 Correlation ID: 114e3ef4-5193-4491-be54-caf74f75b5b0 Timestamp: 2026-01-18 00:17:02Z","error_codes":[700213],"timestamp":"2026-01-18 00:17:02Z","trace_id":"41f1be3d-c2c1-485d-ae44-90570aaf0200","correlation_id":"114e3ef4-5193-4491-be54-caf74f75b5b0","error_uri":"https://login.microsoftonline.com/error?code=700213"}[0m
	            	[31m│[0m [0m
	            	[31m│[0m [0m[0m  with provider["registry.terraform.io/hashicorp/azurerm"],
	            	[31m│[0m [0m  on main.tf line 12, in provider "azurerm":
	            	[31m│[0m [0m  12: provider "azurerm" [4m{[0m[0m
